...
import 'package:photo_view/photo_view.dart'; // استيراد مكتبة عرض الصور في شاشة كاملة
import '../colors.dart';

class LaboratoryDetailScreen extends StatefulWidget {
  final Map<String, dynamic> data;

  const LaboratoryDetailScreen({Key? key, required this.data}) : super(key: key);
...
class _LaboratoryDetailScreenState extends State<LaboratoryDetailScreen> {
  ...
  void _playAudio(String url) async {
    try {
      await _audioPlayer.play(url as Source); // تشغيل الصوت باستخدام الرابط
      print('Audio playing'); // سيتم طباعة هذه الرسالة بعد النجاح
    } catch (e) {
      print('Error playing audio: $e'); // سيتم طباعة الخطأ إذا حدث
    }
  }
